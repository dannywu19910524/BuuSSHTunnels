...
- Paste a full SSH command to configure (e.g. `ssh -L 3306:localhost:3306 user@server`)
...
1. Download `Buu SSH Tunnels.zip`
...
4. Enter a name and SSH command, then click Add
